...
//lógica de captura de tamanio de array con menos 1, para que el valor capturado sea igual al numero que precisamos capturar
...
//Dibujando los campos a donde las letras serán digitadas
function dibujarLineas() {
    ...
    //en cada iteración posible en el bucle se creará un dibujo
    for (let i = 1; i < numeroDeLetras; i++) {

        // el tamanio del trazo en relación a la pantalla
        let x = 60 * i;
...
function capturarLetra(evento) {
    ...
    //determinar con la tabla qué claves se pueden guardar
